...
import ProgramStats from './Stats/ProgramStats.jsx'
  ...
  return (
    <>
      ...
      <div className = '"overflow-hidden w-3/4 h-3/4 mx-auto my-auto mt-40"'>
        {
          toggle[0] == 1 ? <ProgramFlow appId = {applicationId} /> : null
        }
        {
          toggle[1] == 1 ? <ProgramStats appId = {applicationId} /> : null
        }
        {
          toggle[2] == 1 ? <Function appId = {applicationId} /> : null
        }
